---
title: "WT chimera: Normalisation"
...
write.table(sizeFactors(sce), quote = F, col.names = F, row.names = F, file = "/nfs/research1/marioni/jonny/chimera-wt/data/sizefactors.tab")
```
