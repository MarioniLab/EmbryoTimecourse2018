...
raw_counts = readMM(paste0("/nfs/research1/marioni/jonny/chimera-wt/cellranger_out/sample_",
                           samp.num, 
...
mtx_loc = paste0("/nfs/research1/marioni/jonny/chimera-wt/cellranger_out/sample_", 1:6, "/outs/raw_gene_bc_matrices/mm10_tomato/matrix_unswapped.mtx")
bc_loc = paste0("/nfs/research1/marioni/jonny/chimera-wt/cellranger_out/sample_", 1:6, "/outs/raw_gene_bc_matrices/mm10_tomato/barcodes_unswapped.tsv")
...
```{r investigate-edrops, fig.cap = "Background vector contributions from barcode libraries of different sizes. Sample 3 is shown, chosen arbitratily."}
...
set.seed(42)
#do call
outs = lapply(matrices, emptyDrops, niters = 200000, ignore = 4999, BPPARAM = mcparam, lower = 60)
...
```{r save}
#save
dump_var = writeMM(counts, file = "/nfs/research1/marioni/jonny/chimera-wt/data/raw_counts.mtx")
write.table(barcodes, file = "/nfs/research1/marioni/jonny/chimera-wt/data/barcodes.tsv", col.names = FALSE, row.names = FALSE, quote = FALSE)
dump_var = file.copy(from = "/nfs/research1/marioni/jonny/chimera-wt/cellranger_out/sample_1/outs/raw_gene_bc_matrices/mm10_tomato/genes.tsv", 
                     to = "/nfs/research1/marioni/jonny/chimera-wt/data/genes.tsv",
                     overwrite = TRUE)
