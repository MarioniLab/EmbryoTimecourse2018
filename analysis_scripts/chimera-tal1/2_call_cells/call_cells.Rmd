---
title: "Tal1 chimera: Cell calling"
...
raw_counts = readMM(paste0("/nfs/research1/marioni/jonny/chimera-tal1/cellranger_out/sample_",
                           samp.num, 
...
mtx_loc = paste0("/nfs/research1/marioni/jonny/chimera-tal1/cellranger_out/sample_", 1:4, "/outs/raw_gene_bc_matrices/mm10_tomato/matrix_unswapped.mtx")
...
```{r save}
#save
dump_var = writeMM(counts, file = "/nfs/research1/marioni/jonny/chimera-tal1/data/raw_counts.mtx")
write.table(barcodes, file = "/nfs/research1/marioni/jonny/chimera-tal1/data/barcodes.tsv", col.names = FALSE, row.names = FALSE, quote = FALSE)
dump_var = file.copy(from = "/nfs/research1/marioni/jonny/chimera-tal1/cellranger_out/sample_1/outs/raw_gene_bc_matrices/mm10_tomato/genes.tsv", 
                     to = "/nfs/research1/marioni/jonny/chimera-tal1/data/genes.tsv",
                     overwrite = TRUE)
